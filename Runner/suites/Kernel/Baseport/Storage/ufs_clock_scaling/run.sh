...
if UFS_MAX_FREQ_NODE=$(ufs_get_dt_node_path "/sys/devices/platform/soc@0/*ufs*/devfreq/*ufs*/max_freq"); then
...
if UFS_MIN_FREQ_NODE=$(ufs_get_dt_node_path "/sys/devices/platform/soc@0/*ufs*/devfreq/*ufs*/min_freq"); then
