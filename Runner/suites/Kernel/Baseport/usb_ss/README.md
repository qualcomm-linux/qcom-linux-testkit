...
# USB SuperSpeed Validation

## Overview

This shell script executes on the DUT (Device-Under-Test) and verifies successful enumeration of connected USB Devices in SuperSpeed (SS - 5000 Mb/s) .

---

## Setup

- Connect SS USB peripheral(s) to USB port(s) on DUT.
...
cd <path-on-device>/Runner && ./run-test.sh usb_ss
```
