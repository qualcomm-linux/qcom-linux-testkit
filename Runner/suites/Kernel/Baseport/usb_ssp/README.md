...
# USB SuperSpeed Plus Validation

## Overview

This shell script executes on the DUT (Device-Under-Test) and verifies successful enumeration of connected USB Devices in SuperSpeed Plus (SSP).
...
cd <path-on-device>/Runner && ./run-test.sh usb_ssp
```
